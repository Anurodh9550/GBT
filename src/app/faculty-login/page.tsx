  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (msg.includes("Failed to fetch") || msg.includes("NetworkError")) {
        ...
        setError(msg || "Invalid employee ID or password.");
      }
    }
  };
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-300 px-4 py-3 text-sm focus:border-brand-green focus:outline-none focus:ring-1 focus:ring-brand-green"
                />
              </div>
              <div>
              ...
              <button type="submit" className="btn-primary w-full justify-center !bg-brand-green !shadow-[0_2px_8px_rgba(45,106,46,0.35)]">
                Login
              </button>
            </form>
