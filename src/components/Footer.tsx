  ...
  return (
    ...
    >
      ...
      <div className="border-b border-white/10">
        <MotionStagger className="mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {[
            { title: "Quick Links", items: mainNav },
            { title: "Student Portal", items: portalNav },
          ].map((col) => (
            <MotionItem key={col.title}>
              <h3 className="text-eyebrow mb-5 text-brand-orange">{col.title}</h3>
